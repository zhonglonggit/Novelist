...
<script type="text/javascript" charset="utf-8"
	src="js/jquery.lazyload.min.js"></script>
</head>
<!--<img src="图片地址" data-original="图片延迟加载" onerror="加载错误时的图片">-->
<body>
	<!-- 公共头 -->
	<script type="text/javascript" src="files/ggsmd.js"></script>
	<script src="images/pagetop2015_0827.js" charset="gb2312"
		type="text/javascript"></script>
	<script src="images/dd.menu-aim.js" charset="gb2312"
		type="text/javascript"></script>
	<!-- KinSlideshow图片轮换 -->
	...
	<div style="width: 1200px; margin: 0 auto; height: 505px;">
		...
		<!-- 菜单 -->
		<div class="divmenu">
			<a href="javascript:void(0)">首页</a> <a href="javascript:void(0)">预售</a>
			<a href="javascript:void(0)">特价</a> <a href="javascript:void(0)">社区</a>
			<a href="javascript:void(0)">电子书</a> <a href="javascript:void(0)">文化用品</a>
		</div>
		<!-- 主体 -->
		<div class="divmian">
			<div id="KinSlideshow" style="visibility: hidden; float: left;">
				<a href="#" target="_blank"><img src="images/lunhuan_1.jpg"
					alt="这是标题一" /></a> <a href="#" target="_blank"><img
					src="images/lunhuan_2.jpg" alt="这是标题二" /></a> <a href="#"
					target="_blank"><img src="images/lunhuan_3.jpg" alt="这是标题三" /></a>
				<a href="#" target="_blank"><img src="images/lunhuan_4.jpg"
					alt="这是标题四" /></a>
			</div>
		</div>
	</div>
	...
	<div class="index_content padding_top_10">
				...
				<div class="index_book_block index_e_goods" dd_name="数字精品书">
					<div class="index_subnav_module">
						<ul class="nav clearfix">
							<li class="first on only_one"><a href="javascript:void(0)"
								target="_blank">精品图书</a></li>
						</ul>
					...
					<div class="content clearfix" style="display: block;">
							...
							<div class="book">
								<div class="bookcover">
									<a target="_blank" href="javascript:void(0)"> <img
										src="images/mej_b.png" alt="满额减" class="promotion_label">
								...
								<div class="bookinfo">
									<div class="title">
										...
										<div class="star">
											<span class="has"></span><span class="has"></span><span
												class="has"></span><span class="has"></span><span
												class="has"></span>
										</div>
										<div class="tienum">
											(<span>999+</span>)条评价
						...
						<div class="index_smallcell_module">
							<div class="book clearfix">
								<div class="bookcover">
									<i class=""></i> <a target="_blank" href="javascript:void(0)">
										<img src="images/mej.png" alt="满额减" class="promotion_label">
										<img src="images/yc_yc_3.jpg" style="display: inline;">
									</a>
								</div>
								<div class="bookinfo">
									<div class="title">
					...
					<div class="index_publish_seller_list">
						<div class="list_content align_two">
							...
							<div class="nopic current fst_level">
								...
								<h3>
									<a href="javascript:void(0)" target="_blank">追风筝的人</a>
								</h3>
								<div class="book_content">
									<div class="cover">
										<a href="javascript:void(0)" target="_blank"> <img
											src="images/yc_yc_3.jpg" alt="" style="display: inline;"></a>
									</div>
									<div class="info">
										<span class="grey">作者：<a href="javascript:void(0)">[美]卡勒德·胡赛尼
												著</a></span>
										<div class="startie">
											<div class="star">
												<span class="has"></span><span class="has"></span><span
													class="has"></span><span></span><span></span>
											</div>
											<div class="tienum">(999+)条评价</div>
										</div>
							...
							<div class="nopic">
								...
								<div class="book_content">
									<div class="info">
										<h3>
											<span class="orange">￥39.90</span><a
												href="javascript:void(0)" target="_blank">追风筝的人</a>
										</h3>
									</div>
								</div>
							</div>
						...
						<div class="list_content align_two">
							...
							<div class="nopic">
								...
								<div class="book_content">
									<div class="info">
										<h3>
											<span class="orange">￥39.99</span><a
												href="javascript:void(0)" target="_blank">追风筝的人</a>
										</h3>
									</div>
								</div>
		...
		<div class="index_bigadcell_module" dd_name="广告一">
			<ul class="index_bigadcell_ul clearfix">
				<li><a target="_blank" href="#"><img src="images/gg_1.jpg"
						style="display: block;"></a></li>
				<li><a target="_blank" href="#"><img src="images/gg_2.jpg"
						style="display: block;"></a></li>
				<li><a target="_blank" href="#"><img src="images/gg_3.jpg"
						style="display: block;"></a></li>
				<li><a target="_blank" href="#"><img src="images/gg_4.jpg"
						style="display: block;"></a></li>
		...
		<!-- 榜单开始 -->
		<div class="index_story padding_top_30 index_bang_story floor_level"
			dd_name="榜单">
			...
			<div class="content clearfix" style="display: block;">
				<div class="index_smallcell_module">
					<div class="book clearfix">
						<div class="bookcover">
							<i class="top1"></i> <a target="_blank" href="javascript:void(0)">
								<img src="images/mej.png" alt="满额减" class="promotion_label">
								<img src="images/yc_yc_3.jpg" style="display: inline;">
							</a>
						</div>
						<div class="bookinfo">
							...
							<div class="startie">
								<div class="star">
									<span class="has"></span><span class="has"></span><span
										class="has"></span><span class="has"></span><span class="has"></span>
								</div>
								<div class="tienum">(999+)条评价</div>
							</div>
							<div class="price">
							...
							<div class="des">如果你“惨”遭抛弃后，忽然有个很强很拽很不可一世的男人向你求婚，你怎么反应？
								贝微微同学的反应是：“大神……你被盗号了么＝ ＝” 这个世界也太不真实了吧！
								...
								那人出身世家，运动全能，外表风雅，气质清华，举止从容，本质……土匪……还傲慢得要死要活…… 这这这样的男人……忽然送上门……
								贝微微抵抗无力，只能被他拖着拽着往前走了……</div>
						</div>
					</div>
				</div>
				<div class="index_smallcell_module">
			...
			<div class="clearfix padding_top_10">
				<div class="index_yuanchuangcell_module">
					<div class="book">
						<div class="bookcover">
							<a target="_blank" href="javascript:void(0)"><img
								src="images/yc_yc_3.jpg" style="display: inline;"></a>
						</div>
						<div class="bookinfo">
							<div class="title">
								<a target="_blank" href="javascript:void(0)" title="追风筝的人">追风筝的人</a>
							...
							<div class="author">[美]卡勒德·胡赛尼</div>
							<div class="read_now">
								<a target="_blank" href="javascript:void(0)">立即购买</a>
							</div>
							<div class="des">我成为今天的我，是在1975年某个阴云密布的寒冷冬日，那年我十二岁。我清楚地记得当时自己趴在一堵坍塌的泥墙后面，窥视着那条小巷，旁边是结冰的小溪。许多年过去了，人们说陈年旧事可以被埋葬，然而我终于明白这是错的，因为往事会自行爬上来。
							</div>
						</div>
		...
		<!-- 大家都在看begin -->
		<div class="index_story index_pindao_total floor_level"
			dd_name="大家都在看">
					...
					<div class="index_pindao_inner clearfix">
						<div class="index_pindaocell_module">
							...
							<div class="mes">
								...
								<p class="dingyue">
									<span class="yue">999+ 人阅读</span> <a href="javascript:void(0)"
										class="go_to_reading_btn" target="_blank"><strong>+</strong>购买</a>
								</p>
							</div>
						</div>
						<div class="index_pindaocell_module">
	...
	<div class="footer">
		...
		<div class="footer_copyright">
			<span>Copyright (C) 当当网 3004-3016, All Rights Reserved</span> <a
				href="#" target="_blank" class="footer_img" rel="nofollow"></a> <span><a
				href="#" target="_blank" rel="nofollow" style="color: #F03;">京ICP证1000000001号</a></span>
