...
<tr>
      ...
      <td><div style="text-align:right; margin:5px 10px 5px 0px"><a href="page/index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a href="page/cart.jsp">&nbsp;购物车</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;订单</div>
              ...
              <tr>
                <td><table cellspacing="1" class="carttable">
                  ...
                  <table width="100%" border="0" cellspacing="0">
				   ...
				   <hr/> 
				   <p style="text-align:center"><a href="page/success2.jsp"><img src="images/finalbutton.gif" width="204" height="51" border="0" /></a></p></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
